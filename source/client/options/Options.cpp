...
Options::Options(Minecraft* mc, const std::string& folderPath) :
	...
	, m_logoType("gfx_logotype", "options.logoType", LOGO_3D, ValuesBuilder().add("options.logoType.auto").add("options.logoType.pocket").add("options.logoType.java").add("options.logoType.console").add("options.logoType.xbox360").add("options.logoType.logo3d"))
